            ...
            card([
                ...
                html.Div([
                    ...
                    dcc.Input(id='start-date-input', type='number', placeholder='ex : 2015',
                              min=1900, max=2100, style={**_INPUT, 'marginBottom': '12px'}),
                    _field_label("Colonne de filtre (ex : LOB)", optional=True),
                    dcc.Dropdown(id='filter-column', options=[], placeholder='Aucune',
                                 style={'marginBottom': '8px'}),
                    _field_label("Valeur à garder (ex : auto)", optional=True),
                    dcc.Input(id='filter-value', type='text', placeholder='ex : auto',
                              style={**_INPUT, 'marginBottom': '4px'}),
                ], style={
